...
export function MobileNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
      <div className="bg-white/95 backdrop-blur-xl border-t border-neutral-lightGray/50 shadow-[0_-4px_24px_rgba(4,28,74,0.06)]">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "text-brand-royal"
                    : "text-neutral-darkGray hover:text-brand-royal"
                )}
              >
