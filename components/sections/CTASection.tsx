    ...
    <section className="relative py-20 md:py-32 overflow-hidden bg-brand-bg">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center relative">
          {/* Decorative elements */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-brand-navy/3 via-brand-royal/3 to-brand-electric/3 blur-3xl -z-10 motion-safe:animate-pulse-soft" />
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-neutral-darkGray mb-10 max-w-2xl mx-auto"
          >
          ...
          <motion.p
            ...
            className="text-neutral-darkGray/60 text-sm mt-6"
          >
