...
const DEFAULT_EXAMS = [
    {
        ...
        subjects: [
            { name: "Physics", topics: ["Mechanics", "Electrodynamics", "Optics", "Thermodynamics", "Modern Physics", "Waves & Oscillations", "Electromagnetism"] },
            { name: "Chemistry", topics: ["Physical Chemistry", "Organic Chemistry", "Inorganic Chemistry", "Chemical Bonding", "Thermodynamics & Equilibrium", "Electrochemistry", "Coordination Compounds"] },
            { name: "Mathematics", topics: ["Algebra", "Calculus", "Coordinate Geometry", "Trigonometry", "Vectors & 3D Geometry", "Probability & Statistics", "Matrices & Determinants"] },
        ],
        totalMarks: 300,
        totalQuestions: 75,
        timeLimit: 180,
    ...
    },
    {
        ...
        category: "medical",
        subjects: [
            { name: "Physics", topics: ["Mechanics", "Thermodynamics", "Electrostatics", "Optics", "Modern Physics", "Magnetism", "Waves & Sound"] },
            { name: "Chemistry", topics: ["Physical Chemistry", "Organic Chemistry", "Inorganic Chemistry", "Chemical Kinetics", "Biomolecules", "Coordination Compounds", "Periodic Table"] },
            { name: "Biology", topics: ["Cell Biology", "Genetics & Evolution", "Human Physiology", "Plant Physiology", "Ecology", "Reproduction", "Biotechnology"] },
        ],
        totalMarks: 720,
        totalQuestions: 180,
        timeLimit: 200,
    ...
    },
    {
        ...
        category: "other",
        subjects: [
            { name: "English", topics: ["Reading Comprehension", "Verbal Ability", "Grammar", "Vocabulary", "Para Jumbles", "Synonyms & Antonyms"] },
            { name: "General Test", topics: ["General Knowledge", "Current Affairs", "Quantitative Reasoning", "Logical Reasoning", "Numerical Ability", "General Mental Ability"] },
            { name: "Mathematics", topics: ["Algebra", "Calculus", "Geometry", "Trigonometry", "Statistics", "Probability", "Matrices"] },
        ],
        totalMarks: 800,
        totalQuestions: 160,
        timeLimit: 180,
    ...
    },
    {
        ...
        category: "management",
        subjects: [
            { name: "VARC", topics: ["Reading Comprehension", "Para Jumbles", "Para Summary", "Sentence Correction", "Odd Sentence Out", "Verbal Reasoning"] },
            { name: "DILR", topics: ["Data Interpretation", "Logical Reasoning", "Seating Arrangement", "Venn Diagrams", "Data Sufficiency", "Puzzles"] },
            { name: "Quantitative Aptitude", topics: ["Arithmetic", "Algebra", "Geometry", "Number System", "Modern Math", "Percentages & Averages", "Time, Speed & Distance"] },
        ],
        totalMarks: 198,
        totalQuestions: 66,
        timeLimit: 120,
    ...
    },
    {
        ...
        category: "law",
        subjects: [
            { name: "English", topics: ["Reading Comprehension", "Grammar", "Vocabulary", "Cloze Test", "Sentence Correction"] },
            { name: "Legal Reasoning", topics: ["Contracts", "Torts", "Criminal Law", "Constitutional Law", "Family Law", "Legal Maxims"] },
            { name: "Logical Reasoning", topics: ["Syllogisms", "Blood Relations", "Puzzles", "Seating Arrangement", "Statement & Assumptions", "Coding-Decoding"] },
            { name: "GK & Current Affairs", topics: ["National Affairs", "International Affairs", "Awards & Honors", "Sports", "Static GK", "Legal Current Affairs"] },
            { name: "Quantitative Techniques", topics: ["Percentages", "Ratio & Proportion", "Time & Work", "Profit & Loss", "Data Interpretation", "Mensuration"] },
        ],
        totalMarks: 120,
        totalQuestions: 120,
        timeLimit: 120,
    ...
    },
    {
        ...
        category: "engineering",
        subjects: [
            { name: "General Aptitude", topics: ["Verbal Ability", "Numerical Ability", "Logical Reasoning", "Data Interpretation"] },
            { name: "Engineering Mathematics", topics: ["Linear Algebra", "Calculus", "Differential Equations", "Probability & Statistics", "Complex Analysis", "Numerical Methods"] },
            { name: "Core Subject", topics: ["Strength of Materials", "Fluid Mechanics", "Thermodynamics", "Engineering Mechanics", "Material Science", "Heat Transfer"] },
        ],
        totalMarks: 100,
        totalQuestions: 65,
        timeLimit: 180,
