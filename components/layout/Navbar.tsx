...
const megaMenu = {
  academic: {
    ...
    items: [
      ...
      { title: "Maharashtra Textbooks", href: "/academic/maharashtra-board/textbooks", desc: "Official eBalbharati PDF links" },
      { title: "PYQs & Sample Papers", href: "/academic/pyqs", desc: "Download official papers" },
